...
define('VIDEO_SERVER','http://bordon.xicp.net:8888/phpcms/uploadfile/video/');
...
class pc_base {
	...
	public static function ftp_upload($file){
	 $ftp_server="bordon.xicp.net"; 
	 $ftp_user_name="upload"; 
	 $ftp_user_pass="upload"; 
	 $local_file=PHPCMS_PATH.'uploadfile/video/'.$file;
