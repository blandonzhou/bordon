...
<img src="<?php 
	if($info['channelid'] == 3){
		$filename = basename($info['picpath']);
		$ext = explode('.',$filename);
		$ext = $ext[0];
		$info['picpath'] = 'uploadfile/thumb/' .$ext. '.jpg';
	}

echo $info['picpath'] ? $info['picpath'] : IMG_PATH.'admin_img/bfqicon1.jpg';?>" width="100px" />	
</td>
