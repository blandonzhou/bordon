...
class mooc {
	...
	public function init() {
        ...
        public function video(){
            $modelid=191;
            include template('content','video');
        }
        public function flipped(){
            include template('content','flipped');
        }
        public function teacher(){
            include template('content','teacher');
        }
        public function starschool(){
            include template('content','starschool');
        }
        public function maward(){
            include template('content','maward');
        }
        public function school(){
            include template('content','school');
        }
	//内容页
...
/* 修改源码		 */
		$rs['local_video'] = str_replace('|','',$rs['local_video']);
...
/* 修改源码	end	 */	
	...
	public function lists() {
		...
		$page = intval($_GET['page']);
                ...
                if(!isset($_GET['t']))  showmessage(L('template_not_exists'),'blank');
		$template = $_GET['t'];
