                    ...
                    <div class="part01 clearfix">
                        ...
                        <div class="p_l">
                            ...
                            <div  id="search-data"  style="background-color:#FFF">
                                <dl class="searchitem">
                                    <dt class="blue"><span>年级：</span> <?php $n=1;if(is_array(filters('nianji',$modelid))) foreach(filters('nianji',$modelid) AS $r) { ?>
                                        <?php echo $r['menu'];?>
                                        <?php $n++;}unset($n); ?> </dt>
                                </dl>
                                <dl class="searchitem">
                                    <dt class="blue"><span>学科：</span> <?php $n=1;if(is_array(filters('xueke',$modelid))) foreach(filters('xueke',$modelid) AS $r) { ?>
                                        <?php echo $r['menu'];?>
                                        <?php $n++;}unset($n); ?> </dt>
                                </dl>  
                                <dl class="searchitem">
                                    <dt class="blue"><span>学段：</span> <?php $n=1;if(is_array(filters('xueduan',$modelid))) foreach(filters('xueduan',$modelid) AS $r) { ?>
                                        <?php echo $r['menu'];?>
                                        <?php $n++;}unset($n); ?> </dt>
                                </dl>       
                            </div>
...
<!--//--><![CDATA[//><!--
                ...
                <div class="wrap"> 
                    ...
                    <div class="part02">
                        <div class="tit02">
                            <h2 class="fbluel"><a target="_blank" href="url" onclick="javascript:void(0);
                                    return false;">讲师</a></h2>
                        </div>
