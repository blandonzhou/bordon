    ...
    <head>
        ...
        <meta name="keywords" content="<?php echo $SEO['keyword'];?>">
            <meta name="description" content="<?php echo $SEO['description'];?>">
                ...
                <div class="wrap"> 
                    <div class="blk_login">
                        <p class="lf fred"><a class="saveBtn" href="javascript:void(0)" onclick="addFavorite(window.location.href, document.title)">收藏</a></p>
                            ...
                            <div class="cont">
                                ...
                                <div class="blk07">
                                    <div class="pic"> 
                                        ...
                                        <?php $src = $img[0]?>		  
                                        <a href="<?php echo $r['url'];?>" target="_blank"><img src="<?php echo $r['thumb'];?>" width="660" height="285"/> </a> </div>
                                    <div class="txt_bg"></div>
                                    <div class="txt">
                                        <h3 class="update">what?</h3>
                                        <h4>
                                            <a href="<?php echo $r['url'];?>" target="_blank">

                                                <?php echo $r['title'];?></a></h4>
                                        <p><?php echo $r['description'];?></p>
                                        <p> <a href="<?php echo $r['url'];?>" target="_blank" class="vidoPlay"><?php echo $r['title'];?></a></p>
                                        <?php $n++;}unset($n); ?>  
                            ...
                            <div class="blk08">
                                ...
                                <div class="pictxt">
                                    ...
                                    <div class="txt">
                                        ...
                                        <p style="padding:0px 0px 10px 100px;"><?php echo $CATEGORYS[$catid]['description'];?></p>
                                        <p title="">
                    ...
                    <div class="part01 clearfix">
                        <div class="p_l">
                            ...
                            <div  id="search-data"  style="background-color:#FFF">
                                <dl class="searchitem">
                                    <dt class="blue"><span>年级：</span> <span style="display:inline-block;width:590px;vertical-align:top"><?php $n=1;if(is_array(filters('nianji',$modelid))) foreach(filters('nianji',$modelid) AS $r) { ?>
                                        <?php echo $r['menu'];?>
                                        <?php $n++;}unset($n); ?> </span></dt>
                                </dl>
                                <dl class="searchitem">
                                    <dt class="blue"><span>学科：</span> <span style="display:inline-block;width:590px;vertical-align:top"><?php $n=1;if(is_array(filters('xueke',$modelid))) foreach(filters('xueke',$modelid) AS $r) { ?>
                                        <?php echo $r['menu'];?>
                                        <?php $n++;}unset($n); ?> </span></dt>
                                </dl>  
                                <dl class="searchitem">
                                    <dt class="blue"><span>学段：</span> <span style="display:inline-block;width:590px;vertical-align:top"><?php $n=1;if(is_array(filters('xueduan',$modelid))) foreach(filters('xueduan',$modelid) AS $r) { ?>
                                        <?php echo $r['menu'];?>
                                        <?php $n++;}unset($n); ?> </span></dt>
                                </dl>       
                            </div>
                            <div class="cont_bg">
                                <div class="cont">
                                    ...
                                    <div class="blk01">
                                        ...
                                        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=10d5421a96fb6a527fc0416572d98b03&action=lists&catid=%24catid&where=%24sql&order=updatetime+DESC&return=info&moreinfo=1&page=%24page&urlrule=%24urlrule\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 20;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('catid'=>$catid,'where'=>$sql,'order'=>'updatetime DESC','moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$info = $content_tag->lists(array('catid'=>$catid,'where'=>$sql,'order'=>'updatetime DESC','moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?>   
                                        <?php $l = count($info)?>
                        ...
                        <div class="p_r">
                            ...
                            <div class="blk03">
                                ...
                                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=584e8d76d31a75d320c1de1ae3b6a2ae&action=position&posid=1&order=listorder+DESC&num=7&catid=%24catid&moreinfo=1\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'position')) {$data = $content_tag->position(array('posid'=>'1','order'=>'listorder DESC','catid'=>$catid,'moreinfo'=>'1','limit'=>'7',));}?>
                                <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                                <?php $img = explode('.',$v[local_video])?>
                                <?php $src = $img[0]?>
