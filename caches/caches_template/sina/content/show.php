...
<script type="text/javascript">
	...
	var flashvars={
		...
		f:'<?php  echo 'redirec.php?v='.base64_encode($video_url);?>',//视频地址
      ...
      <div id="scr_cont3">
        <div class="blk02">
          <div class="pictxt clearfix">
            ...
            <div class="txt fblue"> 讲师：<?php echo $tea_name;?><br/>
              学校：<a href="<?php echo $CATEGORYS[$catid]['url'];?>" target="_blank"><?php echo $CATEGORYS[$catid]['catname'];?></a> </div>
          </div>
...
<div class="part02">
<?php if($count) { ?>
  <h2 class="tit01"><span class="noteBg">共有<span class="fred"><?php echo $count;?></span>课 </span></h2>
