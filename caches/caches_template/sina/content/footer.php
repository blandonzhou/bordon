...
<script type="text/javascript">
	...
	var doc = document,
		...
		side = (function() {
			...
			strwrite = "<img src='https://chart.googleapis.com/chart?cht=qr&chs=90x90&choe=UTF-8&chld=L|4&chl=" + thisURL + "' width='90' height='90' alt='网址二维码' />"; 

			wrap.innerHTML = '<a class="side-btns-2wm-img" target="_blank" href="#" title="手机端快速访问" suda-uatrack="key=qr_code&value=open_index_qrcode"><em>使用手机扫描</em> '+strwrite+' <span>使用手机扫描</span> </a> <a href="javascript:;" class="side-btns-2wm-close" title="关闭" suda-uatrack="key=qr_code&value=open_index_qrcode_close">关闭</a>';
